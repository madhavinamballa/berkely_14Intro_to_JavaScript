...
Object.values(userInfo).forEach(value => console.log(`my name is ${value}`))
Object.entries(userInfo).forEach(([key,value])=> console.log(`key: ${key}`))
...
// Object.entries(userInfo).forEach(([keym, value]) => console.log(`Key: ${key} and Value ${value}`));
